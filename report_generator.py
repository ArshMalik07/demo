# # Function Service-8
# # report_generator.py: Generates final analytics report
...
#     # -----------------------------
#     # Brand Scoring (MODEL AWARE)
#     # -----------------------------
#     brand_scores = score_brand_dimensions(
#         company,
#         category,
#         text_corpus,
#         model_key
...
#     # -----------------------------
#     # Persona Scoring (MODEL AWARE)
#     # -----------------------------
#     persona_scores = score_personas(
#         text_corpus,
#         model_key
#     )
